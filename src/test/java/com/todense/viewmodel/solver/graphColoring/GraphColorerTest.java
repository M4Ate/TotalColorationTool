...
class GraphColorerTest {
    ...
    void getColoredGraphTest() {
        ...
        String jsonResponse = "{\"error\":false,\"errorMessage\":\"\",\"result\":[{\"variable\":\"x_v0_c0\",\"value\"" +
                ":1},{\"variable\":\"x_v0_c1\",\"value\":0},{\"variable\":\"x_v0_c2\",\"value\":0},{\"variable\":" +
                "\"x_v0_c3\",\"value\":0},{\"variable\":\"x_v1_c0\",\"value\":0},{\"variable\":\"x_v1_c1\",\"value\"" +
                ":0},{\"variable\":\"x_v1_c2\",\"value\":1},{\"variable\":\"x_v1_c3\",\"value\":0},{\"variable\":" +
                "\"x_v2_c0\",\"value\":0},{\"variable\":\"x_v2_c1\",\"value\":1},{\"variable\":\"x_v2_c2\",\"value\"" +
                ":0},{\"variable\":\"x_v2_c3\",\"value\":0},{\"variable\":\"y_e0_c0\",\"value\":0},{\"variable\":" +
                "\"y_e0_c1\",\"value\":1},{\"variable\":\"y_e0_c2\",\"value\":0},{\"variable\":\"y_e0_c3\"," +
                "\"value\":0},{\"variable\":\"y_e1_c0\",\"value\":1},{\"variable\":\"y_e1_c1\",\"value\":0}," +
                "{\"variable\":\"y_e1_c2\",\"value\":0},{\"variable\":\"y_e1_c3\",\"value\":0},{\"variable\":"+
                "\"y_e2_c0\",\"value\":0},{\"variable\":\"y_e2_c1\",\"value\":0},{\"variable\":\"y_e2_c2\"," +
        ...
        assertEquals("0xff0000ff", result.getEdges().get(0).getColor().toString());
        assertEquals("0x00ff00ff", result.getEdges().get(1).getColor().toString());
        assertEquals("0x01fffeff", result.getEdges().get(2).getColor().toString());
    }
